...
Event ID 4624 | Successful Logon | 587 | Account successfully logged on to the system
Event ID 4672 | Special Privileges Assigned | 558 | Sensitive privileges assigned to new logon session
Event ID 4798 | Group Membership Enumerated | 3,085 | Process enumerated user's local group memberships
...
* Count of 3,085 is 2.7x higher than combined logon events (1,145)
...
* Excessive Group Enumeration (3,085 vs 587 logons - 5:1 ratio) - Event ID 4798
...
* Volume Anomaly - 3,085 x Event ID 4798 - excessive group enumeration, 5x higher than logon count
* Temporal Pattern - Burst clusters at 16:10-16:16 - multiple events per second in tight repeated intervals
* Privilege Anomaly - 558 x Event ID 4672 - special privileges assigned at every logon (persistent admin access)
